...
app = Flask(__name__)
CORS(app, origins=["http://localhost:5173", "https://tripping-puce.vercel.app","https://tripping-msy823iu3-novs-projects-c22b7ac3.vercel.app/login"], supports_credentials=True)
